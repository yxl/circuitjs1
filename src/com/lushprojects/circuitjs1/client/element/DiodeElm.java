...
/*	if (modelName == null) {
    ...
    public void getInfo(String[] arr) {
        if (model.oldStyle)
            ...
            arr[0] = CirSim.LS("diode") + " (" + modelName + ")";
    ...
    public EditInfo getEditInfo(int n) {
        ...
        if (n == 1) {
            ...
            ei.button = new Button(CirSim.LS("Edit Model"));
            return ei;
        }
        if (n == 2) {
            EditInfo ei = new EditInfo("", 0, -1, -1);
            ei.button = new Button(CirSim.LS("Create Simple Model"));
            return ei;
        }
    ...
    public void setEditValue(int n, EditInfo ei) {
        ...
        if (n == 1) {
            if (model.readOnly) {
                Window.alert(CirSim.LS("This model cannot be modified.  Change the model name to allow customization."));
                return;
            }
        ...
        if (n == 2) {
            String val = Window.prompt(CirSim.LS("Fwd Voltage @ 1A"), CirSim.LS("0.8"));
            try {
