...
public class ScopePopupMenu {
    ...
    private final MenuBar m;
    private final MenuItem removeScopeItem;
    private final CheckboxMenuItem maxScaleItem;
    private final MenuItem stackItem;
    private final MenuItem unstackItem;
    private final MenuItem combineItem;
    private final MenuItem removePlotItem;
